...
public class Adaptor_cancel extends BaseAdapter {
    Context context;
    List<model> strings;

    public Adaptor_cancel(Context context, List<model> strings) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = LayoutInflater.from(context).inflate(R.layout.item_list_cancel, parent, false);
